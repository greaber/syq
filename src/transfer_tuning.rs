...
impl std::fmt::Display for TransferTuning {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        pair!("s3-object-workers", self.s3_object_workers);
        pair!("s3-part-workers", self.s3_part_workers);
