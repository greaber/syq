# syq detailed reference

This document contains the complete command and behavior reference. It
describes the current `master` branch; for a released version, read the
documentation at that release's Git tag. Start with the project
[README](../README.md) for scope, installation, and common commands.
...
For the supported cases below, placement follows rsync:
...
The [rsync compatibility record](../RSYNC-COMPAT.md) tracks compatibility in
full: what matches, what
