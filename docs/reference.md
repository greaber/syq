...
reported and skipped because macOS cannot create them through the confined
destination directory descriptor; regular files and other special files in
the same copy continue normally. Ownership follows the same
