...
syq, before it runs. This needs an official release build; a build from Cargo
or a checkout must be told where a matching remote `syq` lives, as
[Installing](install.md) describes.
