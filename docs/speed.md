...
Smaller files still travel together in batches. See [copy files](reference.md#copy-files)
for the cloning threshold, how tuning changes it, and the cases that use normal
copying.
