...
| resume | `partial` | pass | Intentional divergence | fixture adaptation (syq-partial-layout) | platform=linux,macos; signals; bandwidth limiting | An interrupted transfer leaves SYQ's job-scoped deterministic sidecar and a rerun completes it. |
